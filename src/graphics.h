...
#define IB_GRAPHICS_DEF_WIDTH 800
#define IB_GRAPHICS_DEF_HEIGHT 600
...
void ib_graphics_draw_texture_ex(ib_graphics_texture* t, ib_graphics_point pos, ib_graphics_point size, float rad, int flip_h, int flip_v);

/* helper macros to make things a little more readable */

#define ib_graphics_draw_texture(t, pos) ib_graphics_draw_texture_ex(t, pos, t->size, 0.0f, 0, 0)
#define ib_graphics_draw_texture_size(t, pos, size) ib_graphics_draw_texture_ex(t, pos, size, 0.0f, 0, 0)
#define ib_graphics_draw_texture_rot(t, pos, rot) ib_graphics_draw_texture_ex(t, pos, t->size, rot, 0, 0)
