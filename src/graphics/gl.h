...
extern void   (APIENTRY * ib_glBindFramebuffer)(GLenum target, GLuint buf);
extern void   (APIENTRY * ib_glBindRenderbuffer)(GLenum target, GLuint buf);
...
extern GLenum (APIENTRY * ib_glCheckFramebufferStatus)(GLenum target);
...
extern void   (APIENTRY * ib_glDeleteFramebuffers)(GLsizei n, const GLuint* p);
extern void   (APIENTRY * ib_glDeleteProgram)(GLuint prg);
extern void   (APIENTRY * ib_glDeleteRenderbuffers)(GLsizei n, const GLuint* p);
...
extern void   (APIENTRY * ib_glDrawBuffers)(GLsizei n, const GLenum* bufs);
...
extern void   (APIENTRY * ib_glFramebufferTexture)(GLenum target, GLenum attachment, GLuint texture, GLint level);
extern void   (APIENTRY * ib_glFramebufferRenderbuffer)(GLenum target, GLenum attachment, GLenum rbt, GLuint rb);
extern void   (APIENTRY * ib_glGenBuffers)(GLsizei n, GLuint* p);
extern void   (APIENTRY * ib_glGenFramebuffers)(GLsizei n, GLuint* p);
extern void   (APIENTRY * ib_glGenRenderbuffers)(GLsizei n, GLuint* p);
...
extern GLenum (APIENTRY * ib_glGetError)();
...
extern void   (APIENTRY * ib_glRenderbufferStorage)(GLenum target, GLenum internal, GLsizei width, GLsizei height);
